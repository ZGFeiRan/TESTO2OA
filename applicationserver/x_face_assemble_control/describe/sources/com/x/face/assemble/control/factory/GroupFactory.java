...
public class GroupFactory extends AbstractFactory {
	...
	private Group pickObject(String flag) throws Exception {
		Group o = this.entityManagerContainer().flag(flag, Group.class, ExceptionWhen.none, false, Group.FLAGS);
		if (o != null) {
			...
			if (matcher.find()) {
				...
				o = this.entityManagerContainer().flag(unique, Group.class, ExceptionWhen.none, false, Group.FLAGS);
				if (null != o) {
					this.entityManagerContainer().get(Group.class).detach(o);
				}
			}
