...
public class PersonFactory extends AbstractFactory {
	...
	private Person pickObject(String flag) throws Exception {
		Person o = this.entityManagerContainer().flag(flag, Person.class, ExceptionWhen.none, false, Person.FLAGS);
		if (o != null) {
			...
			if (matcher.find()) {
				...
				o = this.entityManagerContainer().flag(unique, Person.class, ExceptionWhen.none, false, Person.FLAGS);
				if (null != o) {
					this.entityManagerContainer().get(Person.class).detach(o);
				}
			}
