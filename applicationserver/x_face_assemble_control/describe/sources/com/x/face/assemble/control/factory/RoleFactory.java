...
public class RoleFactory extends AbstractFactory {
	...
	private Role pickObject(String flag) throws Exception {
		Role o = this.entityManagerContainer().flag(flag, Role.class, ExceptionWhen.none, false, Role.FLAGS);
		if (o != null) {
			...
			if (matcher.find()) {
				...
				o = this.entityManagerContainer().flag(unique, Role.class, ExceptionWhen.none, false, Role.FLAGS);
				if (null != o) {
					this.entityManagerContainer().get(Role.class).detach(o);
				}
			}
